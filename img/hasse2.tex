...
\begin{tikzpicture}
  \draw (0, 0)    node[circle, fill, color=dep] (o) {};
  \draw (-1.5, 1) node[circle, fill, color=dep] (a) {};
  \draw (0, 1)    node[circle, fill, color=dep] (b) {};
  ...
  \draw[line width=2pt, color=dep] (a) -- (o);
  \draw[line width=2pt, color=dep] (b) -- (o);
  \draw[line width=2pt, color=dep] (c) -- (o);
  \draw[dashed] (o)   -- (2.5, 0) node[right] {$0$ 段目};
  \draw[dashed] (c)   -- (2.5, 1) node[right] {$1$ 段目};
  \draw[dashed] (bc)  -- (2.5, 2) node[right] {$2$ 段目};
  \draw[dashed] (abc) -- (2.5, 3) node[right] {$3$ 段目};
\end{tikzpicture}